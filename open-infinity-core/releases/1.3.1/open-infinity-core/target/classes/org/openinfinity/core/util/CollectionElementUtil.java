...
public class CollectionElementUtil {
	 ...
	 * @param collection Represents typesafe <code>java.util.Collection</code>.
	 * @param callback Represents the <code>java.util.Collection</code> element callback interface.
	 * @param traversalObject Represents the <code>java.util.Collection</code> element callback interface.
	 */
	public static <V, TraversalObject extends Object> void iterate(Collection<V> collection, CollectionElementCallback<V> callback, TraversalObject traversalObject) {
		for (V value : collection) {
			if (value != null)
				callback.callback(value, traversalObject);
		}
	}
